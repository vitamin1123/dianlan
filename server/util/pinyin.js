!
function(n, a) {
    "object" == typeof exports && "object" == typeof module ? module.exports = a() : "function" == typeof define && define.amd ? define([], a) : "object" == typeof exports ? exports.PinyinMatch = a() : n.PinyinMatch = a()
...
function() {
    return function(n) {
        ...
        function i(u) {
            ...
            return n[u].call(e.exports, e, e.exports, i),
            e.l = !0,
            e.exports
        }
        return i.m = n,
        i.c = a,
        i.d = function(n, a, u) {
            i.o(n, a) || Object.defineProperty(n, a, {
                enumerable: !0,
                get: u
            })
        },
        ...
        i.t = function(n, a) {
            ...
            if (i.r(u), Object.defineProperty(u, "default", {
                enumerable: !0,
                value: n
            }), 2 & a && "string" != typeof n) for (var e in n) i.d(u, e,
            function(a) {
                return n[a]
            }.bind(null, e));
            return u
    ...
    function(n, a, i) {
        "use strict";
        var u = i(0).pinyin_dict_notone,
        e = i(0).allPinyin,
        o = function() {
            var n = {};
            for (var a in u) for (var i = u[a], e = 0, o = i.length; e < o; e++) n[i[e]] ? n[i[e]] = n[i[e]] + " " + a: n[i[e]] = a;
            return n
        } (),
        g = {};
        function h(n) {
            for (var a = [], i = (n.length, []), u = 0; u <= n.length; u++) i.push(!0);
            return function n(a, i, u, o, g) {
                if (a === i.length) return void o.push(u.join(" "));
                var h = function(h) {
                    ...
                    if (e.some(function(n) {
                        ...
                        if (1 === t.length) u.push(t);
                            ...
                            e.forEach(function(n) {
                                0 === n.indexOf(t) && c.push(n)
                            }),
                            u.push(c)
                        }
                        r = !0
                    } else - 1 !== e.indexOf(t) && g[h + 1] && (u.push(t), r = !0);
                    if (r) {
                        var s = o.length;
                        n(h + 1, i, u, o, g),
                        o.length === s && (g[h + 1] = !1),
        ...
        function c(n, a, i) {
            ...
            e = 0; e < a.length; e++) {
                ...
                g = o.length,
                h = g === i.length;
                if (g <= u) for (var t = 0; u - t >= g;) {
                    for (var c = !0,
                    s = 0,
                    l = 0,
                    f = 0; f < o.length; f += 1) if (0 === f && " " === n[t + f + s]) s += 1,
                    f -= 1;
                    else if (" " === n[t + f + l]) l += 1,
                    f -= 1;
                    else if (!r(n[t + f + l], o[f], !n[t + f + 1] || !o[f + 1], h)) {
                        t += 1,
                        c = !1;
                        break
                    }
                    if (c) return [t + s, t + l + f - 1]
                }
            }
            return ! 1
        }
        var s = {
            match: function(n, a) {
                ...
                var u = c(n.split(""), [a.split("")], a);
                return u || c(function(n) {
                    for (var a = [], i = 0, u = n.length; i < u; i++) {
                        var e = n.charAt(i);
                        a.push(o[e] || e)
                    }
                    return a
